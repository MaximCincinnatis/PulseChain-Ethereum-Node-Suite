...
main_menu() {
    while true; do
        options=$(dialog --stdout --title "PulseChain Node Menu $VERSION" --backtitle "PulseChain Node Setup by Maxim Broadcast" --menu "Choose an option:" 0 0 0 \
                      ...
                      "Info and KeyManagment" "Tools for Key Management and Node Information" \
                      "-" ""\
...
validator_submenu() {
    while true; do
        val_opt=$(dialog --stdout --title "Validator-Client Menu $VERSION" --backtitle "PulseChain Node Setup by Maxim Broadcast" --menu "Choose an option:" 0 0 0 \
...
validator_setup_submenu() {
    while true; do
        ...
        vs_opt=$(dialog --stdout --title "Info and KeyManagment $VERSION" --backtitle "PulseChain Node Setup by Maxim Broadcast" --menu "Choose an option:" 0 0 0 "${options[@]}")
        case $? in
            0)
                case $vs_opt in
                    "Key Management")
